...
void JavaMethodUnit::addSubUnit(const std::shared_ptr<Unit> &subUnit, Unit::Flags accessType = 0)
{
    subUnits.push_back(subUnit);
}

std::vector<std::string> JavaMethodUnit::Compile(unsigned int level)
{
